...
public final class Matcher
{
	 ...
	 * should rather pre parse the pattern using tokenizePathAsArray.
	 * 
	...
	public static boolean matchPath(Set<String[]> patternSet, String str)
	{
		...
		{
			if(matchPath(patternTokens, tokenizePathAsArray(str), CASE_SENSITIVE))
			{
				return true;
			}
		}
	...
	/**
	 * Tests whether or not a given path matches a given pattern. If you need to
	 * call this method multiple times with the same pattern you should rather
	 * pre parse the pattern using tokenizePathAsArray.
	 * 
	 * @see #tokenizePathAsArray
	...
	public static boolean matchPath(String pattern, String str)
	{
		...
		return matchPath(patDirs, tokenizePathAsArray(str), CASE_SENSITIVE);
	}
