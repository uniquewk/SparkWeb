...
public class TimeUtils
{
	...
	/**
	 * Thanks to Quartz project, https://quartz.dev.java.net Provides a parser
	 * and evaluator for unix-like cron expressions. Cron expressions provide
	 * the ability to specify complex time combinations such as &quot;At 8:00am
	 * every Monday through Friday&quot; or &quot;At 1:30am every last Friday of
	 * the month&quot;.
	 * <P>
	...
	public static class CronExpression implements Serializable, Cloneable
	{
		 ...
		 *            the new object should represent
		...
		/**
		 * Indicates whether the given date satisfies the cron expression. Note
		 * that milliseconds are ignored, so two Dates falling on different
		 * milliseconds of the same second will always have the same result
		 * here.
		 * 
		...
		/**
		 * Returns the next date/time <I>after</I> the given date/time which
		 * does <I>not</I> satisfy the expression
		 * 
		 * @param date the date/time at which to begin the search for the next
		 *            invalid date/time
		 * @return the next valid date/time
		...
		/**
		 * Returns the time zone for which this <code>CronExpression</code> will
		 * be resolved.
		 */
		...
		/**
		 * Advance the calendar to the particular hour paying particular
		 * attention to daylight saving problems.
		 * 
		 * @param cal
		 * @param hour
		 */
