...
import com.sparkweb.binding.types.DateBinder;
import com.sparkweb.binding.types.DateTimeBinder;
import com.sparkweb.binding.types.LocaleBinder;
...
public abstract class Binder 
{
    ...
    static final Map<Class<?>, BeanWrapper> beanwrappers = new HashMap<Class<?>, BeanWrapper>(100);
    ...
    public static Object bind(Class<?> beanClass, Map<String, String[]> params) throws Exception {
        return bind(beanClass, null, params);
    }
    
    public static Object bind(Class<?> beanClass, String alias, Map<String, String[]> params) throws Exception {
		Constructor<?> constructor = beanClass.getDeclaredConstructor();
		constructor.setAccessible(true);
		
        return bind(constructor.newInstance(), alias, params);
    }
    
    public static Object bind(Object beanInstance, Map<String, String[]> params) {
        return bind(beanInstance, null, params);
    }
    
    public static Object bind(Object beanInstance, String alias, Map<String, String[]> params) {
    	if(beanInstance == null || params == null || params.isEmpty())
    	{
    		return beanInstance;
    	}
    	
        RootParamNode parentParamNode = ParamNode.convert(params);
        Binder.bindBean(parentParamNode, alias, beanInstance);
        ...
        if (result == MISSING) {
            ...
            if (methodAndParamInfo != null) {
                try {
                    ...
                    throw new com.sparkweb.exception.UnexpectedException(e);
                }
            }
     ...
     */
    private static void bindBean(RootParamNode rootParamNode, String name, Object bean) {

        ParamNode paramNode = (name == null || name.trim().length() == 0) ? rootParamNode : rootParamNode.getChild(name);
     ...
     */
    protected static void bindBean(ParamNode paramNode, Object bean, Annotation[] annotations) throws Exception {
     ...
     * @throws Exception
     */
    private static Object directBind(String name, Annotation[] annotations, String value, Class<?> clazz, Type type) throws Exception {
