...
public class VelocityView extends ViewToolManager
{
	...
	protected static final String	CONTENT_TYPE_KEY				= "default.contentType";

	/**
	 * Key used to access the ServletContext in the Velocity application
	 * attributes.
	 */
	protected static final String	SERVLET_CONTEXT_KEY				= ServletContext.class.getName();
	 ...
	 * attributes.
	 */
	protected static final String	TOOLS_KEY						= ServletUtils.CONFIGURATION_KEY;
	@Deprecated
	protected static final String	DEPRECATED_TOOLS_KEY			= "org.apache.velocity.toolbox";

	/**
	 * Default toolbox configuration file path. If no alternate value for this
	 * is specified, the servlet will look here.
	 */
	protected static final String	USER_TOOLS_PATH					= "/WEB-INF/tools.xml";
	@Deprecated
	protected static final String	DEPRECATED_USER_TOOLS_PATH		= "/WEB-INF/toolbox.xml";

	/**
	 * Default Runtime properties.
	 */
	protected static final String	DEFAULT_PROPERTIES_PATH			= "/org/apache/velocity/tools/view/velocity.properties";

	/**
	 * This is the string that is looked for when getInitParameter is called
	 * ("org.apache.velocity.properties").
	 */
	protected static final String	PROPERTIES_KEY					= "org.apache.velocity.properties";

	/**
	 * Default velocity properties file path. If no alternate value for this is
	 * specified, the servlet will look here.
	 */
	protected static final String	USER_PROPERTIES_PATH			= "/WEB-INF/velocity.properties";
	 ...
	 */
	protected static final String	LOAD_DEFAULTS_KEY				= "org.apache.velocity.tools.loadDefaults";
	 ...
	 */
	protected static final String	CLEAN_CONFIGURATION_KEY			= "org.apache.velocity.tools.cleanConfiguration";
	 ...
	 */
	protected static final String	USER_OVERWRITE_KEY				= "org.apache.velocity.tools.userCanOverwriteTools";
	 ...
	 */
	protected static final String	DEPRECATION_SUPPORT_MODE_KEY	= "org.apache.velocity.tools.deprecationSupportMode";
	...
	protected VelocityView(ServletContext context) {
		this(new JeeContextConfig(context));
	}

	protected VelocityView(JeeConfig config) {
	 ...
	 * been called.
	 */
	public String getProperty(String key, String alternate)
	{
	...
	protected void setEncoding(JeeConfig config)
	{
		...
		if(!DEFAULT_OUTPUT_ENCODING.equalsIgnoreCase(encoding))
		{
			...
			else
			{
				...
				getLog().info(
						"Charset was already " + "specified in the Content-Type property.  "
	 ...
	 *             available source.
	 * @throws ParseErrorException if template cannot be parsed due to syntax
	 *             (or other) error.
	 */
